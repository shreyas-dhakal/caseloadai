...
function App() {
  ...
  return <div className="site-shell">
    <header className="nav"><a className="brand" href="#top"><span className="brand-mark">C</span><span>caseload<span className="brand-ai">AI</span></span></a><nav><a href="#product">Product</a><a href="#workflow">How it works</a><a href="#why-now">Why now</a></nav><button className="button button-lime nav-button" onClick={openDemo}>Request a demo <Arrow /></button><button className="mobile-menu" onClick={() => scrollTo("product")} aria-label="Jump to product">☰</button></header>
    <main id="top">
