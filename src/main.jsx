...
const Logo = ({ className = "" }) => <span className={`logo-image ${className}`} aria-label="Caseload AI"><img src="/caseloadai.png" alt="" /><img src="/caseloadai.png" alt="" /></span>;
const Logo2 = ({ className = "" }) => <span className={`logo-image ${className}`} aria-label="Caseload AI"><img src="/caseloadai2.png" alt="" /><img src="/caseloadai2.png" alt="" /></span>;
    ...
    <div className="preview-window">
      ...
      <div className="preview-body">
        <aside className="preview-rail">
          <div className="mini-logo"><Logo2 /></div>
        ...
        <main className="preview-main">
          <div className="preview-heading"><div><small>MONDAY, 14 OCTOBER</small><h3>Good morning, YCombinator.</h3></div><button>+ New note</button></div>
          ...
          <div className="note-card">
            <div className="note-card-head"><div><small>RECENT NOTE · JUST NOW</small><h4>Progress note · Sam Sawyer</h4></div><span className="approved">✓ Approved</span></div>
            <p>Sam shared that the new morning routine is helping them feel more confident before work. They would like to continue building...</p>
    ...
    <section id="languages" className="language-section section-pad">
      <div className="language-intro">
        ...
        <div className="language-copy">
          <p>Capture the conversation in their own language. Caseload supports voice-led notes across <strong>up to 15 languages</strong>, while keeping the record clear for every member of the team.</p>
...
function App() {
  ...
  return <div className="site-shell">
     <header className="nav"><a className="brand" href="#top"><Logo /></a><nav><a href="#product">Product</a><a href="#workflow">How it works</a><a href="#languages">Languages</a><a href="#why-now">Why now</a></nav><button className="button button-lime nav-button" onClick={openDemo}>Request a demo <Arrow /></button><button className="mobile-menu" onClick={() => scrollTo("product")} aria-label="Jump to product">☰</button></header>
    <main id="top">
     ...
     <footer className="footer"><a className="brand" href="#top"><Logo /></a><span>© 2026 Caseload AI. Built for better support.</span><span>Made for the NDIS community <span className="footer-heart">✦</span></span></footer>
